...
const getUsers = async (req, res) => {
  try {
    const users = await User.find({}).select("fullName email contact")
...
const updateRoom = async (req, res) => {
  try {
    ...
    console.log(roomType,currentPrice)
    const room = await Room.findOneAndUpdate({roomType:roomType},{
...
module.exports = {getUser, getRooms, getBookings, getPayments, updateRoom, createRoom,getUsers };
